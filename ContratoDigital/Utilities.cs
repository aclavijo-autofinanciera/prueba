...
namespace ContratoDigital
{
    ...
    static public class Utilities
    {
        ...
        static public void FillPdf(IDictionary<String, PdfFormField> fields, ContratoDigitalModel persona)
        {
            PdfFormField toSet;
        ...
        static public ContratoDigitalModel FillPersona(IFormCollection form)
        {
